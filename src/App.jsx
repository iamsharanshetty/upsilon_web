  ...
  return (
    <nav
      className={`fixed w-full z-50 transition-all duration-300 ${
        scrolled
          ? "bg-slate-950/95 backdrop-blur-lg shadow-lg shadow-lime-500/5"
          : "bg-transparent"
      }`}
    >
        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            <div className="relative">
              <div className="w-12 h-12 bg-gradient-to-br from-lime-400 to-yellow-400 rounded-lg flex items-center justify-center transform group-hover:scale-105 transition-transform duration-200 shadow-lg shadow-lime-500/30">
                {/* <span className="text-2xl font-bold text-slate-900">Υ</span> */}
                <img
                  src="/upsilon-logo.jpeg"
                  alt="Upsilon"
                  className="w-12 h-12 object-contain rounded-lg"
                />
              </div>
            </div>
            <span className="text-2xl font-bold bg-gradient-to-r from-lime-400 to-yellow-400  bg-clip-text text-transparent">
              Upsilon AI
            </span>
          </div>
          ...
          <div className="px-4 py-6 space-y-4">
            {menuItems.map((item) => (
              <button
                key={item}
                onClick={() => handleNavClick(item)}
                className="block w-full text-left text-slate-300 hover:text-lime-400 transition-colors"
              >
                {item}
              </button>
            ))}
...
const Hero = ({ setCurrentPage }) => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>

      <div className="absolute top-20 right-10 w-72 h-72 bg-lime-500/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-yellow-500/10 rounded-full blur-3xl"></div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-block mb-6 px-4 py-2 bg-lime-500/10 border border-lime-500/30 rounded-full backdrop-blur-sm">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
          <span className="bg-gradient-to-r from-lime-400 via-yellow-400 to-lime-500 bg-clip-text text-transparent">
            Supercharge Your
          </span>
          <br />
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="group bg-gradient-to-r from-lime-500 to-yellow-400 hover:from-lime-600 hover:to-yellow-500 text-slate-900 px-8 py-4 rounded-lg font-semibold transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg shadow-lime-500/50"
          >
          ...
          <button
            ...
            className="border-2 border-lime-500 text-lime-400 hover:bg-lime-500/10 px-8 py-4 rounded-lg font-semibold transition-all duration-200"
          >
            Explore Services
          </button>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <ChevronRight className="w-6 h-6 text-lime-400 rotate-90" />
      </div>
    </section>
  );
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((item, idx) => (
            <div
              key={idx}
              className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-xl border border-slate-700 hover:border-lime-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-lime-500/20"
            >
              <CheckCircle className="w-12 h-12 text-lime-400 mb-4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((industry, idx) => (
            <div
              key={idx}
              className="bg-gradient-to-br from-slate-800 to-slate-900 p-6 rounded-xl border border-slate-700 hover:border-lime-500/50 transition-all duration-300 cursor-pointer group"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {universities.map((uni, idx) => (
            <div
              key={idx}
              className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-xl border border-slate-700 hover:border-lime-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-lime-500/20 text-center group"
            >
              <div className="mb-4 flex justify-center">
                <img
                  src={uni.logo}
                  alt={`${uni.name} logo`}
                  className="w-24 h-24 object-contain group-hover:scale-110 transition-transform rounded-lg"
                />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="bg-gradient-to-br from-slate-900 to-slate-800 p-8 rounded-xl border border-slate-700 hover:border-lime-500 transition-all duration-300"
            >
              ...
              <div className="flex flex-wrap gap-3">
                {service.features.map((feature, i) => (
                  <span
                    key={i}
                    className="px-4 py-2 bg-lime-500/10 border border-lime-500/30 rounded-full text-lime-400 text-sm"
                  >
                    {feature}
                  </span>
                ))}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-12 rounded-xl border border-slate-700 text-center">
            ...
            <div className="space-y-4">
              ...
              <a
                href="mailto:nagarjun@upsilonai.co"
                className="inline-flex items-center space-x-2 bg-gradient-to-r from-lime-500 to-yellow-400 hover:from-lime-600 hover:to-yellow-500 text-slate-900 px-8 py-4 rounded-lg font-semibold transition-all duration-200"
              >
                <Mail className="w-5 h-5" />
                <span>nagarjun@upsilonai.co</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <input
                ...
                required
                className="w-full px-6 py-4 bg-slate-900 border border-slate-700 rounded-lg focus:outline-none focus:border-lime-500 transition-colors text-white placeholder-slate-500"
              />
              <input
                type="email"
                name="email"
            ...
            <textarea
              ...
              required
              className="w-full px-6 py-4 bg-slate-900 border border-slate-700 rounded-lg focus:outline-none focus:border-lime-500 transition-colors text-white placeholder-slate-500 resize-none"
            />
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-lime-500 to-yellow-400 hover:from-lime-600 hover:to-yellow-500 text-slate-900 px-8 py-4 rounded-lg font-semibold transition-all duration-200 shadow-lg shadow-lime-500/50"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          <div className="bg-slate-900 p-6 rounded-xl border border-slate-700">
            <Mail className="w-8 h-8 text-lime-400 mb-3" />
            <h3 className="font-bold mb-2">Email</h3>
            <p className="text-slate-400">aryan@upsilonai.co</p>
          </div>
          <div className="bg-slate-900 p-6 rounded-xl border border-slate-700">
            <Phone className="w-8 h-8 text-lime-400 mb-3" />
            <h3 className="font-bold mb-2">Phone</h3>
            <p className="text-slate-400">+65 9851 5567</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              <li className="flex items-center space-x-2">
                ...
                <span>aryan@upsilonai.co</span>
              </li>
              <li className="flex items-center space-x-2">
                <Phone className="w-4 h-4" />
                <span>+65 9851 5567</span>
              </li>
            </ul>
